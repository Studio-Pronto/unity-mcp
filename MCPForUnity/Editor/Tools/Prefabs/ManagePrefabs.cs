...
namespace MCPForUnity.Editor.Tools.Prefabs
{
    ...
    public static class ManagePrefabs
    {
        ...
        private const string SupportedActions = ACTION_CREATE_FROM_GAMEOBJECT + ", " + ACTION_GET_INFO + ", " + ACTION_GET_HIERARCHY + ", " + ACTION_MODIFY_CONTENTS + ", " + ACTION_GET_OVERRIDES + ", " + ACTION_REVERT_OVERRIDES + ", " + ACTION_OPEN_PREFAB_STAGE + ", " + ACTION_SAVE_PREFAB_STAGE + ", " + ACTION_CLOSE_PREFAB_STAGE;
